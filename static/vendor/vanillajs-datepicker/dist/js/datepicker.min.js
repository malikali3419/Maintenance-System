var Datepicker = function() {
    ...
    function q(t, s) {
        ...
        if (a.language) {
            ...
            if (a.language !== o && (r[a.language] ? e = a.language : void 0 === r[e = a.language.split("-")[0]] && (e = !1)), delete a.language, e) {
                ...
                c = Object.assign({
                    format: H,
                    weekStart: $
                }, r[T]), o !== T && Object.assign(c, r[o]), n.locale = c, d === t.format && (d = n.format = c.format), g === t.weekStart && (g = n.weekStart = c.weekStart, n.weekEnd = j(c.weekStart))
            }
        }
        if (a.format) {
        ...
        if (void 0 !== a.weekStart) {
            ...
            isNaN(e) || (g = n.weekStart = e, n.weekEnd = j(e)), delete a.weekStart
        }
